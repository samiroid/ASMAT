...
#%%
path = "/Users/samir/Dev/projects/ASMAT/experiments/sma/results/lowres_sma.txt"
df = helpers.read_results(path,models=["BOW-freq","BOW-bin","BOE-bin"])
f,ax = plt.subplots(1,1)
# # df = helpers.get_df(my_data)
MIN_Y=0.3
MAX_Y=1.1
plots.plot_df(df,ax,x="dataset",ys=df.columns[1:].tolist(),cols=plots.PALETTE_1,ylabel="avg. F1", min_y=MIN_Y, max_y=MAX_Y)
plt.tight_layout()
