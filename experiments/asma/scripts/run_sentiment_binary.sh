...
for ds in $sentiment_datasets; 
do
    ./experiments/asma/scripts/neural_ASMA.sh $ds~BINARY sentiment~BINARY.txt str_skip_50.txt
    echo $ds~BINARY >> "done_sentiment-binary.txt"
done
...
for ds in $sentiment_datasets; 
do
    ./experiments/asma/scripts/neural_ASMA.sh $ds~BINARY sentiment200~BINARY.txt str_skip_200.txt
    echo $ds~BINARY >> "done_sentiment-binary.txt"
done
...
for ds in $sentiment_datasets; 
do
    ./experiments/asma/scripts/neural_ASMA.sh $ds~BINARY sentiment400~BINARY.txt str_skip_400.txt
    echo $ds~BINARY >> "done_sentiment-binary.txt"
done
