...
def search_architecture(U, max_l, params):
    ...
    confs = itertools.product(filter_sizes,n_hiddens,n_filters)
    ...
    for conf in confs:
        ...
        print "\n\n"
        filter_size    = conf[0]
        n_feature_maps = conf[1]
        n_filter       = conf[2]

        hidden_units[0] = n_feature_maps
        ...
        with open("DATA/pkl/arch_results.pkl","w") as fid:
...
if __name__=="__main__":
    ...
    search_architecture(U, max_l, parameters)

    with open("DATA/pkl/arch_results.pkl","r") as fid:
