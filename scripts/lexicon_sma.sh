...
BASE="/Users/samir/Dev/projects/phd_research/low_resource_sma/experiments/lexicon_sma/"$DATASET"/"
...
# python ASMAT/models/lexicon_model.py -lex DATA/lexicons/semlex.txt -ts DATA/test/HCR_test.txt -res experiments/lexicon_sma/results
